  ...
  <div class="min-h-screen bg-stone-50/30">
    ...
    <div class="container mx-auto px-6 py-20">
      <div class="max-w-4xl mx-auto">
        <h1 class="text-5xl font-extralight text-stone-800 mb-6 tracking-wider leading-tight">Works</h1>
        <p class="text-stone-600 font-light mb-12 text-lg leading-relaxed tracking-wide">作品集 - Digital Art & Photography</p>
    ...
    <div class="container mx-auto px-6 relative">
      ...
      <!-- Gallery Items -->
      <div v-else class="space-y-24 max-w-6xl mx-auto">
        <GalleryTimelineItem
          ...
          <div class="mb-8 border border-stone-200/60 rounded-xl hover:border-stone-300/80 transition-all duration-500">
            ...
            <div class="p-8 border-b border-stone-200/40">
              <div class="flex items-center justify-between">
                ...
                <button
                  ...
                  class="flex items-center gap-3 px-4 py-2 text-sm text-stone-500 hover:text-stone-700 border border-stone-200/60 rounded-lg transition-all duration-300 hover:bg-stone-50/50 font-light tracking-wide"
                >
            ...
            <div class="p-6">
              ...
              <div v-if="(item.images?.length || 0) > 3" class="text-center mt-6">
                <span class="text-xs text-stone-400 font-light tracking-wide">還有 {{ (item.images?.length || 0) - 3 }} 張作品</span>
              </div>
            </div>
    ...
    <div class="container mx-auto px-6 py-24 text-center">
      <div class="text-3xl font-extralight text-stone-300 italic tracking-wider">friday vibes</div>
