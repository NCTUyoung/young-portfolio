<template>
  ...
  >
    <a
      ...
      :class="bare ? bareClass : pillClass"
    >
      <!-- GitHub -->
      <svg
...
const props = withDefaults(
  defineProps<{
    /** Footer: icon-only row. Default: bordered pills (About section). */
    variant?: 'pill' | 'bare'
  }>(),
  { variant: 'pill' }
)
...
const items = [
  { title: 'GitHub', href: SOCIAL_LINKS.github, icon: 'github' as const, newTab: true },
  { title: 'Facebook', href: SOCIAL_LINKS.facebook, icon: 'facebook' as const, newTab: true },
  { title: 'Instagram', href: SOCIAL_LINKS.instagram, icon: 'instagram' as const, newTab: true },
  { title: 'Threads', href: SOCIAL_LINKS.threads, icon: 'threads' as const, newTab: true },
  { title: 'Email', href: SOCIAL_LINKS.email, icon: 'email' as const, newTab: false },
]
</script>
